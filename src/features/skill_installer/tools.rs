...
pub struct Extension {
    ...
    /// Whether this extension uses embedded content generated by the executor
    /// instead of being downloaded from a GitHub repository
...
const EXTENSIONS: &[Extension] = &[
    ...
    // Embedded extensions - content generated by executor, not downloaded from GitHub
    Extension {
        name: "loop-runner",
    ...
    fn test_embedded_extension_available_for_all_clis() {
        for cli in &[CliType::Claude, CliType::Codex, CliType::Gemini] {
            ...
            assert!(
                ...
                "Embedded extension should be available for {:?}",
                cli.display_name()
            );
        }
    }
